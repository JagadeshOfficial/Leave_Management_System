...
export default function MyLeavesPage() {
    ...
    const leaveRequestHistory = [
        { id: 1, type: 'Privilege Leave', dates: 'Oct 24 - Oct 28', days: 5, status: 'Approved', requestedOn: 'Oct 10, 2026' },
        { id: 2, type: 'Sick Leave', dates: 'Sep 12', days: 1, status: 'Rejected', requestedOn: 'Sep 12, 2026' },
        { id: 3, type: 'Casual Leave', dates: 'Aug 05', days: 1, status: 'Pending', requestedOn: 'Aug 01, 2026' },
        { id: 4, type: 'Sick Leave', dates: 'Jul 20 - Jul 21', days: 2, status: 'Approved', requestedOn: 'Jul 20, 2026' },
    ];

    const upcomingHolidays = [
        { name: 'Diwali', date: 'Nov 12', day: 'Thursday', type: 'Public Holiday' },
        { name: 'Christmas', date: 'Dec 25', day: 'Friday', type: 'Public Holiday' },
        { name: 'New Year', date: 'Jan 01', day: 'Friday', type: 'Public Holiday' },
    ];
                            ...
                            <div className="space-y-4">
                                <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/10 hover:bg-white/20 transition-colors cursor-pointer">
                                    <div className="flex justify-between items-center mb-2">
                                        <span className="font-bold text-white">Diwali Long Weekend</span>
                                    ...
                                    <p className="text-indigo-100 text-sm leading-relaxed">
                                        Take <strong>Friday, Nov 13</strong> off to combine with Diwali (Thu) for a <span className="text-white font-bold decoration-wavy underline decoration-white/30">4-day streak</span>!
                                    </p>
                                </div>

                                <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/10 hover:bg-white/20 transition-colors cursor-pointer">
                                    <div className="flex justify-between items-center mb-2">
                                        <span className="font-bold text-white">Christmas Break</span>
                                    </div>
                                    <p className="text-indigo-100 text-sm leading-relaxed">
                                        Christmas falls on a Friday. Automatic 3-day weekend unlocked! 🎉
                                    </p>
                                </div>
                            </div>
