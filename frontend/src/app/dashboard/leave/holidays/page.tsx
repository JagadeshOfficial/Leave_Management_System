                ...
                {filteredHolidays.map((holiday, idx) => (
                    ...
                    >
                        ...
                        <div className="relative z-10 flex flex-col h-full justify-between gap-6">
                            ...
                            <button className="flex items-center justify-between w-full pt-4 border-t border-slate-50 text-xs font-bold text-slate-400 group-hover:text-slate-800 transition-colors">
