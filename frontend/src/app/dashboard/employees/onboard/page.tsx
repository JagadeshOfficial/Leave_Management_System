                        ...
                        <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm">
                            ...
                            <div className="flex items-center gap-6 mb-8 p-4 bg-slate-50 rounded-2xl border border-dashed border-slate-200">
                                ...
                                <div>
                                    ...
                                    <button className="px-4 py-2 bg-white border border-slate-200 rounded-lg text-sm font-bold text-slate-600 hover:text-blue-600 hover:border-blue-200 transition-colors">Choose File</button>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    <div key={i} className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-dashed border-slate-200 hover:bg-blue-50/30 transition-colors">
                                        ...
                                        <button className="px-4 py-2 bg-white border border-slate-200 text-slate-600 text-xs font-bold rounded-lg hover:border-blue-400 hover:text-blue-600 transition-colors">
                                            Browse
                                        </button>
                                    </div>
                                ))}
